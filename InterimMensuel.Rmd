...
Sur un an, l’emploi intérimaire `r g_verbe0(Regions2[1,3],1)` `r Regions2[1,1]` (soit `r format_delta(Regions2[1,2])` intérimaires) ; il `r g_verbe0(Regions2[2,3],1)`  `r Regions2[2,1]` (soit `r format_delta(Regions2[2,2])` intérimaires) ; il `r g_verbe0(Regions2[3,3],1)` `r Regions2[3,1]` (soit `r format_delta(Regions2[3,2])` intérimaires).
En revanche, l’emploi intérimaire `r g_verbe0(Regions2[A-1,3],1)`  `r Regions2[A-1,1]` (soit `r format_delta(Regions2[A-1,2])` intérimaires) ; il `r g_verbe0(Regions2[A-2,3],1)`  `r Regions2[A-2,1]` (soit `r format_delta(Regions2[A-2,2])` intérimaires) ; il `r g_verbe0(Regions2[A-3,3],1)` `r Regions2[A-3,1]` (soit `r format_delta(Regions2[A-3,2])` intérimaires).
