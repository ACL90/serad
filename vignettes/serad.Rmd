...
[Dernière mise à jour de cette documentation : 3 mai 2023]
...
- Je lui fais installer serad_0.1.5.tar.gz dans un dossier. Disons que ce dossier s'appelle A:
- Puis: ```install.packages("A/serad_0.1.5.tar.gz", repos = NULL, type = "source")```
- Puis: ```vignette("serad")```
