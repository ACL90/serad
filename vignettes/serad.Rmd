...
[Dernière mise à jour de cette documentation : 24 avril 2022]
...
- Je lui fais installer serad_0.1.2.tar.gz dans un dossier. Disons que ce dossier s'appelle A:
- Puis: ```install.packages("A/serad_0.1.2.tar.gz")```
- Puis: ```vignette("serad")```
