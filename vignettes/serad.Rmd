...
knitr::include_graphics("C:/Users/alexandre.cazenave-l/Documents/GitHub/Serad/man/figures/logo.png")
#knitr::include_graphics("~/logo.png") 
```

[Dernière mise à jour de cette documentation : 2 mai 2023]
...
#Astuce : pour les 3 fonctions de formattage, il est possible de modifier le niveau d'arrondi. Il est même possible de modifier le comportement par défaut.
```
...
A certains moments, revient régulièrement dans un commentaire qu'on est au point le plus haut/bas depuis un certain temps. C'est ce qu'automatise `plushautniveau(df,...)` :
```{r }
?plushautniveau
```
...
- Je lui fais installer serad_0.1.4.tar.gz dans un dossier. Disons que ce dossier s'appelle A:
- Puis: ```install.packages("A/serad_0.1.4.tar.gz", repos = NULL, type = "source")```
- Puis: ```vignette("serad")```
