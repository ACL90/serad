...
[Dernière mise à jour de cette documentation : 19 juillet 2023]
...
`quelTrim(mois,annee,...)`, `nextTrim(mois,annee,...)` et `prevTrim(mois,annee,...)` seront utiles pour tout commentaire trimestriel. Des versions mensuelles suivront.
```{r }
?quelTrim   
