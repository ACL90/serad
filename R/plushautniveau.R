...
#' plushautniveau(df1,nbperiode = 5.000000000000001)  #erreur: nbperiode doit
#' etre un nombre entier
#' plushautniveau(df1,nbperiode = 5)  #NA
#' plushautniveau(df1,vary="col2") #"C'est le plus haut niveau depuis le
#' début de la série."
#' plushautniveau(df1,vary="col3") #"C'est le plus bas niveau depuis
#' Y1trim3."
#' plushautniveau(df1,vary="col4") #"C'est le plus bas niveau depuis le début de
#'  la série."
#' @export
