...
#options : getOption("askYesNo")
options(serad.test=c(1,2,3,4))
getOption("serad.test")

#si l'utilisateur veut changer les paramètres par défaut
#default ?
#https://cran.r-project.org/web/packages/default/default.pdf
#pas la meilleure chose a faire, voir ci-dessous :
#https://coolbutuseless.github.io/2018/04/11/changing-the-default-arguments-to-a-function/
getOption("serad.b")


#xfun : https://yihui.org/en/2023/02/xfun-isfalse/
#dependances de dplyr  pak::pkg_deps_tree("dplyr")
